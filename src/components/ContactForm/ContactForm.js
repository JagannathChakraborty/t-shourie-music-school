  ...
  const contactInfo = [
    {
      icon: <FaMapMarkerAlt />,
      title: 'Visit Us',
      content: 'Buxibazar, Cuttack, Odisha',
      link: 'https://maps.google.com/?q=Buxibazar,Cuttack,Odisha',
    },
    {
      icon: <FaPhone />,
      title: 'Call Us',
      content: '9937023166, 9337666349',
      link: 'tel:9937023166',
    },
    {
      icon: <FaEnvelope />,
      title: 'Email Us',
      content: 'info@tshourie.com',
      link: 'mailto:info@tshourie.com',
    },
  ];

  const socialLinks = [
    { icon: <FaFacebook />, name: 'Facebook', url: '#' }, // Add your Facebook URL
    { icon: <FaInstagram />, name: 'Instagram', url: '#' }, // Add your Instagram URL
    { icon: <FaYoutube />, name: 'YouTube', url: '#' }, // Add your YouTube URL
